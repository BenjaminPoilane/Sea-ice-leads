...
scale  = 1;
% Proportion (entre 0 et 1) de l'aire d'un disque d'analyse non recouverte par des données tolerable dans le cas d'un
% champ rgps : 
...
l=round(1000*scale/res); % l est l'échelle d'analyse en pixel
...
champAff=superpose1(champAff,cotesAff,[1,1,1]); % on superpose tout ça au cotes (en noir)
